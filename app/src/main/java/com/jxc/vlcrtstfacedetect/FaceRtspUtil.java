...
public class FaceRtspUtil {
    ...
    public List<Bitmap> detectFrame(Bitmap oldBitmap) {
        ...
        Log.e(TAG,facesArray[0].toString());
        callListener.updata(facesArray[0].x,facesArray[0].y,facesArray[0].width,facesArray[0].height);
        //保存该帧中的所有人脸
    ...
    interface CallListener{
        void updata(int x,int y, int width,int height);
    }
